export class EnvironmentKeys {
  ...
  // Redis
  static readonly APP_ENV_REDIS_SOCKET_IO_HOST = 'APP_ENV_REDIS_SOCKET_IO_HOST';
  static readonly APP_ENV_REDIS_SOCKET_IO_PORT = 'APP_ENV_REDIS_SOCKET_IO_PORT';
  static readonly APP_ENV_REDIS_SOCKET_IO_PASSWORD =
    'APP_ENV_REDIS_SOCKET_IO_PASSWORD';
